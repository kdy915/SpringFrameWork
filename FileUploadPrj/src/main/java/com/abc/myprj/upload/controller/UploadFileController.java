package com.abc.myprj.upload.controller;
...
import com.abc.myprj.upload.service.IUploadFileService;
...
public class UploadFileController {
	...
	public String getImageList(@RequestParam(value="dir", required=false, defaultValue="/images")
		String dir, Model model) {
	...
	public String deleteFile(@PathVariable int fileId) {
		uploadService.delteFile(fileId);
		return "redirect:/upload/list";
	}
